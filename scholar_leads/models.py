...
class CamposPesquisa(BaseModel):
    ...
    """
    nome: str = Field(..., description="reshearcher name")
    email: Optional[str] = Field(None, description="researcher email")
    instituicao: Optional[str] = Field(None, description="researcher institution")
    coautor: Optional[HttpUrl] = Field(None, description="coauthor url")